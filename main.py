...
def run_command(
    ...
    elif dual_mode_enabled and not ip2:
        output = "Error: second IPv4 address is required in dual mode."
    elif dual_mode_enabled and not _is_ipv4(ip2):
        output = "Error: second IPv4 address is invalid."
    elif not username:
